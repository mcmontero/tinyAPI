...
def geo_build():
    ...
    return [
        ...
        tinyAPI.Table(db, 'geo_country_code')
            ...
            .ins(4, 'Andorra', '376')
            .ins(5, 'Angola', '244')
            .ins(6, 'Antarctica', '672')
            .ins(7, 'Argentina', '54')
            .ins(8, 'Armenia', '374')
            .ins(9, 'Aruba', '297')
            .ins(10, 'Australia', '61')
            .ins(11, 'Austria', '43')
            .ins(12, 'Azerbaijan', '994')
            .ins(13, 'Bahrain', '973')
            .ins(14, 'Bangladesh', '880')
            .ins(15, 'Belarus', '375')
            .ins(16, 'Belgium', '32')
            .ins(17, 'Belize', '501')
            .ins(18, 'Benin', '229')
            .ins(19, 'Bhutan', '975')
            .ins(20, 'Bolivia', '591')
            .ins(21, 'Bosnia and Herzegovina', '387')
            .ins(22, 'Botswana', '267')
            .ins(23, 'Brazil', '55')
            .ins(24, 'British Indian Ocean Territory', '246')
            .ins(25, 'Brunei', '673')
            .ins(26, 'Bulgaria', '359')
            .ins(27, 'Burkina Faso', '226')
            .ins(28, 'Burundi', '257')
            .ins(29, 'Cambodia', '855')
            .ins(30, 'Cameroon', '237')
            .ins(31, 'Canada', '1')
            .ins(32, 'Cape Verde', '238')
            .ins(33, 'Central African Republic', '236')
            .ins(34, 'Chad', '235')
            .ins(35, 'Chile', '56')
            .ins(36, 'China', '86')
            .ins(37, 'Christmas Island', '61')
            .ins(38, 'Cocos Islands', '61')
            .ins(39, 'Colombia', '57')
            .ins(40, 'Comoros', '269')
            .ins(41, 'Cook Islands', '682')
            .ins(42, 'Costa Rica', '506')
            .ins(43, 'Croatia', '385')
            .ins(44, 'Cuba', '53')
            .ins(45, 'Curacao', '599')
            .ins(46, 'Cyprus', '357')
            .ins(47, 'Czech Republic', '420')
            .ins(48, 'Democratic Republic of the Congo', '243')
            .ins(49, 'Denmark', '45')
            .ins(50, 'Djibouti', '253')
            .ins(51, 'East Timor', '670')
            .ins(52, 'Ecuador', '593')
            .ins(53, 'Egypt', '20')
            .ins(54, 'El Salvador', '503')
            .ins(55, 'Equatorial Guinea', '240')
            .ins(56, 'Eritrea', '291')
            .ins(57, 'Estonia', '372')
            .ins(58, 'Ethiopia', '251')
            .ins(59, 'Falkland Islands', '500')
            .ins(60, 'Faroe Islands', '298')
            .ins(61, 'Fiji', '679')
            .ins(62, 'Finland', '358')
            .ins(63, 'France', '33')
            .ins(64, 'French Polynesia', '689')
            .ins(65, 'Gabon', '241')
            .ins(66, 'Gambia', '220')
            .ins(67, 'Georgia', '995')
            .ins(68, 'Germany', '49')
            .ins(69, 'Ghana', '233')
            .ins(70, 'Gibraltar', '350')
            .ins(71, 'Greece', '30')
            .ins(72, 'Greenland', '299')
            .ins(73, 'Guatemala', '502')
            .ins(74, 'Guinea', '224')
            .ins(75, 'Guinea-Bissau', '245')
            .ins(76, 'Guyana', '592')
            .ins(77, 'Haiti', '509')
            .ins(78, 'Honduras', '504')
            .ins(79, 'Hong Kong', '852')
            .ins(80, 'Hungary', '36')
            .ins(81, 'Iceland', '354')
            .ins(82, 'India', '91')
            .ins(83, 'Indonesia', '62')
            ...
            .ins(102, 'Liberia', '231')
            .ins(103, 'Libya', '218')
            .ins(104, 'Liechtenstein', '423')
            .ins(105, 'Lithuania', '370')
            .ins(106, 'Luxembourg', '352')
            .ins(107, 'Macao', '853')
            .ins(108, 'Macedonia', '389')
            .ins(109, 'Madagascar', '261')
            .ins(110, 'Malawi', '265')
            .ins(111, 'Malaysia', '60')
            .ins(112, 'Maldives', '960')
            .ins(113, 'Mali', '223')
            .ins(114, 'Malta', '356')
            .ins(115, 'Marshall Islands', '692')
            .ins(116, 'Mauritania', '222')
            .ins(117, 'Mauritius', '230')
            .ins(118, 'Mayotte', '262')
            .ins(119, 'Mexico', '52')
            .ins(120, 'Micronesia', '691')
            .ins(121, 'Moldova', '373')
            .ins(122, 'Monaco', '377')
            .ins(123, 'Mongolia', '976')
            .ins(124, 'Montenegro', '382')
            .ins(125, 'Morocco', '212')
            .ins(126, 'Mozambique', '258')
            .ins(127, 'Myanmar', '95')
            .ins(128, 'Namibia', '264')
            .ins(129, 'Nauru', '674')
            .ins(130, 'Nepal', '977')
            .ins(131, 'Netherlands', '31')
            .ins(132, 'Netherlands Antilles', '599')
            .ins(133, 'New Caledonia', '687')
            .ins(134, 'New Zealand', '64')
            .ins(135, 'Nicaragua', '505')
            .ins(136, 'Niger', '227')
            .ins(137, 'Nigeria', '234')
            .ins(138, 'Niue', '683')
            .ins(139, 'North Korea', '850')
            .ins(141, 'Norway', '47')
            .ins(142, 'Oman', '968')
            .ins(143, 'Pakistan', '92')
            .ins(144, 'Palau', '680')
            ...
            .ins(156, 'Qatar', '974')
            .ins(157, 'Republic of the Congo', '242')
            .ins(158, 'Reunion', '262')
            .ins(159, 'Romania', '40')
            .ins(160, 'Russia', '7')
            .ins(161, 'Rwanda', '250')
            .ins(162, 'Saint Barthelemy', '590')
            .ins(163, 'Saint Helena', '290')
            .ins(166, 'Saint Martin', '590')
            .ins(167, 'Saint Pierre and Miquelon', '508')
            .ins(169, 'Samoa', '685')
            .ins(170, 'San Marino', '378')
            .ins(171, 'Sao Tome and Principe', '239')
            .ins(172, 'Saudi Arabia', '966')
            .ins(173, 'Senegal', '221')
            .ins(174, 'Serbia', '381')
            .ins(175, 'Seychelles', '248')
            .ins(176, 'Sierra Leone', '232')
            .ins(177, 'Singapore', '65')
            .ins(179, 'Slovakia', '421')
            .ins(180, 'Slovenia', '386')
            .ins(181, 'Solomon Islands', '677')
            .ins(182, 'Somalia', '252')
            .ins(183, 'South Africa', '27')
            .ins(184, 'South Korea', '82')
            .ins(185, 'South Sudan', '211')
            .ins(186, 'Spain', '34')
            .ins(187, 'Sri Lanka', '94')
            .ins(188, 'Sudan', '249')
            .ins(189, 'Suriname', '597')
            .ins(190, 'Svalbard and Jan Mayen', '47')
            .ins(191, 'Swaziland', '268')
            .ins(192, 'Sweden', '46')
            .ins(193, 'Switzerland', '41')
            .ins(194, 'Syria', '963')
            .ins(195, 'Taiwan', '886')
            .ins(196, 'Tajikistan', '992')
            .ins(197, 'Tanzania', '255')
            .ins(198, 'Thailand', '66')
            .ins(199, 'Togo', '228')
            .ins(200, 'Tokelau', '690')
            .ins(201, 'Tonga', '676')
            .ins(203, 'Tunisia', '216')
            .ins(204, 'Turkey', '90')
            .ins(205, 'Turkmenistan', '993')
            .ins(207, 'Tuvalu', '688')
            .ins(209, 'Uganda', '256')
            .ins(210, 'Ukraine', '380')
            .ins(211, 'United Arab Emirates', '971')
            .ins(212, 'United Kingdom', '44')
            .ins(213, 'United States', '1')
            .ins(214, 'Uruguay', '598')
            .ins(215, 'Uzbekistan', '998')
            .ins(216, 'Vanuatu', '678')
            .ins(217, 'Vatican', '379')
            .ins(218, 'Venezuela', '58')
            .ins(219, 'Vietnam', '84')
            .ins(220, 'Wallis and Futuna', '681')
            .ins(221, 'Western Sahara', '212')
            .ins(222, 'Yemen', '967')
            .ins(223, 'Zambia', '260')
            .ins(224, 'Zimbabwe', '263')
    ]
